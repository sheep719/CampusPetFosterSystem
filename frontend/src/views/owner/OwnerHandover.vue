  ...
  <div class="owner-handover">
    ...
    <el-card class="table-card" shadow="never">
      <el-table :data="tableData" v-loading="loading" stripe style="width: 100%">
        ...
        <el-table-column label="我的确认" width="100" align="center">
          <template #default="{ row }">
            <el-tag :type="row.ownerConfirmed ? 'success' : 'info'" size="small">
              {{ row.ownerConfirmed ? '已确认' : '未确认' }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column label="操作" width="180" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <el-button type="success" link :icon="Check" @click="handleConfirm(row)" v-if="row.status === 'pending' && !row.ownerConfirmed">确认交接</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      <el-descriptions :column="2" border v-if="currentHandover">
        ...
        <el-descriptions-item label="联系方式">{{ currentHandover.caregiverPhone }}</el-descriptions-item>
    ...
    >
      ...
      <el-form :model="confirmForm" ref="confirmFormRef" label-width="90px">
        ...
        <el-form-item label="交接备注">
          <el-input v-model="confirmForm.notes" type="textarea" :rows="3" placeholder="请输入交接备注（如宠物状态等）" />
        </el-form-item>
...
const mockData = [
  { id: 1, handoverNo: 'HO202401001', applicationNo: 'FA202401001', petName: '咪咪', petSpecies: 'cat', petSpeciesLabel: '猫', caregiverName: '李阿姨', caregiverPhone: '13812345678', type: 'delivery', handoverDate: '2024-01-15', handoverTime: '09:00', location: '学校东门', status: 'completed', notes: '宠物状态良好，已确认交接', photos: mockPhotos, ownerConfirmed: true, ownerConfirmTime: '2024-01-15 09:05', caregiverConfirmed: true, caregiverConfirmTime: '2024-01-15 09:10' },
  { id: 2, handoverNo: 'HO202401002', applicationNo: 'FA202401001', petName: '咪咪', petSpecies: 'cat', petSpeciesLabel: '猫', caregiverName: '李阿姨', caregiverPhone: '13812345678', type: 'pickup', handoverDate: '2024-01-20', handoverTime: '18:00', location: '学校东门', status: 'completed', notes: '宠物状态良好，已接回', photos: mockPhotos.slice(0, 2), ownerConfirmed: true, ownerConfirmTime: '2024-01-20 18:05', caregiverConfirmed: true, caregiverConfirmTime: '2024-01-20 18:10' },
  { id: 3, handoverNo: 'HO202401003', applicationNo: 'FA202401002', petName: '旺财', petSpecies: 'dog', petSpeciesLabel: '狗', caregiverName: '王奶奶', caregiverPhone: '13987654321', type: 'delivery', handoverDate: '2024-01-18', handoverTime: '10:00', location: '学校西门', status: 'completed', notes: '狗狗很活泼，已带好狗粮', photos: mockPhotos, ownerConfirmed: true, ownerConfirmTime: '2024-01-18 10:05', caregiverConfirmed: true, caregiverConfirmTime: '2024-01-18 10:15' },
  { id: 4, handoverNo: 'HO202401004', applicationNo: 'FA202401002', petName: '旺财', petSpecies: 'dog', petSpeciesLabel: '狗', caregiverName: '王奶奶', caregiverPhone: '13987654321', type: 'pickup', handoverDate: '2024-01-25', handoverTime: '17:00', location: '学校西门', status: 'pending', notes: '', photos: [], ownerConfirmed: false, ownerConfirmTime: '', caregiverConfirmed: false, caregiverConfirmTime: '' },
  { id: 5, handoverNo: 'HO202401005', applicationNo: 'FA202401003', petName: '雪球', petSpecies: 'rabbit', petSpeciesLabel: '兔子', caregiverName: '陈阿姨', caregiverPhone: '13711223344', type: 'delivery', handoverDate: '2024-01-22', handoverTime: '14:00', location: '学校北门', status: 'pending', notes: '', photos: [], ownerConfirmed: false, ownerConfirmTime: '', caregiverConfirmed: false, caregiverConfirmTime: '' }
]
...
const handleSubmitConfirm = async () => {
  ElMessageBox.confirm('确认完成交接？确认后表示宠物已安全交接。', '提示', {
